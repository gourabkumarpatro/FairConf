...
mapMatrix = performScheduling(args.num_prio_lvl, lamda, lamda_1, lamda_2,\
                       V, A, cntPerCluster, instanceName, nOrig, lOrig, optzMethod)
...
np.savetxt(writeDirRoot + "/" + instanceName + ".csv", mapMatrix.astype(int), fmt='%i', delimiter = ",") 
print ("Instance \"" + instanceName + "\" saved!")
print ("\n---------------------------------------------------------------------------")   
